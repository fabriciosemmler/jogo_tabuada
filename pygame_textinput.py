...
class TextInputVisualizer:
    ...
    def __init__(self,
        ...
        self._font_object = pygame.font.Font(
            pygame.font.get_default_font(), 25) if font_object is None else font_object
    ...
    def _rerender(self):
        ...
        if self._cursor_visible:
            ...
            cursor_rect = pygame.Rect(
                cursor_y, 0, self._cursor_width, self.font_object.get_height())
...
if __name__ == "__main__":
    ...
    while True:
        ...
        textinput_custom.font_color = [
            (c+10) % 255 for c in textinput_custom.font_color]
